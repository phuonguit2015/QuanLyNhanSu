namespace LeTien.Screens.List
{
    partial class FormViewBranch
    {
        ...
        private void InitializeComponent()
        {
            ...
            // txtTenChiNhanh
            // 
            this.dxErrorProvider1.SetError(this.txtTenChiNhanh, "Tên chi nhánh không được để trống");
            this.dxErrorProvider1.SetErrorType(this.txtTenChiNhanh, DevExpress.XtraEditors.DXErrorProvider.ErrorType.Warning);
            ...
            // txtMaChiNhanh
            // 
            this.dxErrorProvider1.SetError(this.txtMaChiNhanh, "Mã chi nhánh không được để trông");
            this.dxErrorProvider1.SetErrorType(this.txtMaChiNhanh, DevExpress.XtraEditors.DXErrorProvider.ErrorType.Warning);
